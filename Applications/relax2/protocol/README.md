...
4. When adding, inserting or overwriting an item to the protocol list, the current parameters will be saved for this item in the protocol folder
...
Features like waiting times and better file handling will be added in the future.
